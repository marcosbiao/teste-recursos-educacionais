const scenarios = {
  ...
  area: {
    title: "Calcular a área de um retângulo.",
    text: "Leia base e altura, calcule a área e mostre o resultado.",
    input: "base e altura",
    process: "base * altura",
    output: "área do retângulo"
  },
  idade: {
    title: "Verificar maioridade.",
    text: "Leia a idade de uma pessoa e informe se ela é maior de idade.",
    input: "idade",
    process: "idade >= 18",
    output: "maior de idade ou menor de idade"
  }
};
  ...
  buttons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      feedback.textContent = isCorrect
        ? "Correto. Você identificou a função dessa parte no fluxo E P S."
        : "Revise o fluxo: entrada recebe dados, processamento transforma dados, saída apresenta resultado.";
    });
  });
});
